...
def test_construction_set_from_standards_dict():
    ...
    assert cz5_constr_set.wall_set.exterior_construction.identifier == \
        'Typical Insulated Steel Framed Exterior Wall-R19'
    assert cz5_constr_set.wall_set.ground_construction.identifier == \
        'Typical Insulated Basement Mass Wall-R8'
    assert cz5_constr_set.floor_set.exterior_construction.identifier == \
        'Typical Insulated Steel Framed Exterior Floor-R27'
    assert cz5_constr_set.floor_set.ground_construction.identifier == \
        'Typical Insulated Carpeted 8in Slab Floor-R5'
    assert cz5_constr_set.roof_ceiling_set.exterior_construction.identifier == \
        'Typical IEAD Roof-R32'
    assert cz5_constr_set.door_set.exterior_construction.identifier == \
        'Typical Insulated Metal Door-R2'
    assert cz5_constr_set.door_set.overhead_construction.identifier == \
        'Typical Overhead Door-R2'

    assert cz5_constr_set.aperture_set.window_construction.identifier == \
        'U 0.48 SHGC 0.40 Dbl Ref-D Clr 6mm/13mm'
    assert cz5_constr_set.aperture_set.operable_construction.identifier == \
        'U 0.48 SHGC 0.40 Dbl Ref-D Clr 6mm/13mm'
    assert cz5_constr_set.aperture_set.skylight_construction.identifier == \
        'Window_U_0.50_SHGC_0.40_Skylight_Frame_Width_0.430_in'
    assert cz5_constr_set.door_set.exterior_glass_construction.identifier == \
